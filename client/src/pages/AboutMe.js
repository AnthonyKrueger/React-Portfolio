...
export default function AboutMe() {
    return (
        <div className="my-5 pb-5 container mx-auto rounded shadow-sm bg-theme-light">
            <div id="aboutme">
                <Header text="About Me" />
                <div className="px-10 md:px-32">
                    <div className="container rounded w-64 md:w-72 pt-10 flex mx-auto">
                        <img className="rounded border-4 border-theme-accent-light" src={profilePhoto} alt=""></img>
                    </div>
